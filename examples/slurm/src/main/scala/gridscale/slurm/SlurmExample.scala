...
object SlurmExample extends App {
  ...
  val headNode = ssh.SSHServer("134.158.75.71", 22, 1 minutes, Some(10 seconds), proxyJumpHost = Some("134.158.74.194"), proxyJumpPort = Some(22))(authentication, proxyAuth)
