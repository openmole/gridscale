...
trait Examples <: Modules with Settings{
  lazy val gliteExample  = Project(id = "gliteexample", base = file("examples/glite"), settings = defaultSettings ++ exportSettings) dependsOn (gridscaleGlite)
