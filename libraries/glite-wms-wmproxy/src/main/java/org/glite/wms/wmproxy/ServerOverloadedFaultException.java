...
public class ServerOverloadedFaultException extends BaseException {
	/**
	* Constructs an Exception with no specified detail message.
	*/
	public ServerOverloadedFaultException () {
		super();
	}
	/**
	* Constructs an Exception with the specified detail message.
	*/
	public ServerOverloadedFaultException(String message) {
		super(message);
	}
}
