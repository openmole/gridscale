...
class FileCertReader {
    static Logger logger = Logger.getLogger(org.glite.voms.FileCertReader.class.getName());
     ...
     * @throws java.security.cert.CertificateException Thrown if the reading of files fails.
     ...
     * @throws java.io.IOException Thrown if the reading of objects of given type
     * fails.
     ...
     * @throws java.security.cert.CertificateException Thrown if an error occurs while reading the object.
     * @throws java.io.IOException Thrown if an error occurs while reading the object.
     ...
     * @throws java.security.cert.CertificateException Thrown if there is a problem reading the object.
     ...
     * @throws java.io.IOException Thrown if there is a problem skipping.
     */
     ...
     * @throws java.io.IOException Thrown if a problem occurs.
     */
